<p align="left">
  <img src="https://github.com/user-attachments/assets/9e769c43-5907-4b19-a8bb-1b8fcee8c06b" alt="Nexera Legal Logo" width="100">
...
🔗 **API:**  
- `POST /api/nexgen/TaxReportGenerate/` – Generate tax reports based on user input.  
...
🔗 **API:**  
- `POST /api/nexgen/Insights/` – Analyze legal documents for key insights.  
